...
#include "iot_export.h"
    ...
    #define DEVICE_SECRET           "v9mqGzepKEphLhXmAoiaUIR2HZ7XwTky"
#else
    //#define PRODUCT_KEY             "TOrlxET0uDk"
    //#define DEVICE_NAME             "yoko_one"
    //#define DEVICE_SECRET           "YEbpqZit4sjpaKh35odG7Wu0Re0SPXfC"
	#define PRODUCT_KEY             "rgXrFiB4Uts"
	#define DEVICE_NAME             "test_device"
	#define DEVICE_SECRET           "PDzpFCJVujBSfKPdtoToGxNGqyCifiCg"
#endif
...
int mqtt_client(void)
{
   ...
   // iotx_mqtt_topic_info_t topic_msg;
    ...
    do {
        ...
        EXAMPLE_TRACE("\n############################\n")
        EXAMPLE_TRACE("\my whx payload = %s\n",topic_msg.payload);
        EXAMPLE_TRACE("\n############################\n")
